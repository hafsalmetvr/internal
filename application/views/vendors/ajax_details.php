    ...
    <?php if($update) : ?><?php echo form_open(site_url("vendors/update_user/" . $user->ID), array("id" => "invoice_form")) ?><?php endif; ?>
    ...
    <div class="form-group">
        <p><strong><?php echo lang("ctn_1553") ?></strong>: <?php echo $user->username ?></p>
        ...
        <?php endif; ?>
         <p><strong><?php echo lang("ctn_1558") ?></strong>: <?php echo $vendor_detail->vendor_number ?></p>
          <p><strong><?php echo lang("ctn_1540") ?></strong>: <?php echo $vendor_detail->company_name ?></p>
        <p><strong><?php echo lang("ctn_1531") ?></strong>: <?php echo $vendor_detail->phone_number ?></p>
        <p><strong><?php echo lang("ctn_1532") ?></strong>: <?php echo $vendor_detail->contact_person_name ?></p>
         <p><strong><?php echo lang("ctn_1533") ?></strong>: <?php echo $vendor_detail->contact_person_number ?></p>
          <p><strong><?php echo lang("ctn_1534") ?></strong>: <?php echo $vendor_detail->contact_person_position ?></p>
          <p><strong><?php echo lang("ctn_1555") ?></strong>: <?php echo $vendor_detail->vendor_vat_id ?></p>
          <p><strong><?php echo lang("ctn_1116") ?></strong>: <?php echo $vendor_detail->address ?></p>
