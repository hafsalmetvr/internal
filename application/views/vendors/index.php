<div class="white-area-content">
    <div class="db-header clearfix">
        ...
        <div class="db-header-extra form-inline"> 
            ...
            <div class="form-group has-feedback no-margin">
             ...
             <button class="btn btn-primary btn-sm" data-toggle="modal" data-target="#addModal"><?php echo lang("ctn_1552") ?></button>
    ...
    <div class="table-responsive">
        <table id="team-table" class="table table-bordered table-striped table-hover">
            <thead>
                <tr class="table-header"><td><?php echo lang("ctn_1553") ?></td><td><?php echo lang("ctn_1551") ?></td><td><?php echo lang("ctn_1506") ?></td><td><?php echo lang("ctn_24") ?></td><td><?php echo lang("ctn_52") ?></td></tr>
            </thead>
            <tbody>
            </tbody>
        </table>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h4 class="modal-title" id="myModalLabel"><span class="glyphicon glyphicon-folder-open"></span> <?php echo lang("ctn_1554") ?></h4>
        </div>

        <div class="modal-body ui-front">
            <?php echo form_open(site_url("vendors/add_vendor"), array("class" => "form-horizontal")) ?>
            <div class="form-group">
                <label for="p-in" class="col-md-4 label-heading"><?php echo lang("ctn_1553") ?></label>
                <div class="col-md-8">
                    <input type="text" class="form-control" name="vendorname" value="" id="vendorname-search">
                </div>
            </div>
            <div class="form-group">
                <label for="p-in" class="col-md-4 label-heading"><?php echo lang("ctn_1558") ?></label>
                <div class="col-md-8">
                    <input type="text" class="form-control" name="vendorno" value="" id="vendorno-search">
                </div>
            </div>
            <div class="form-group">
                    ...
                    <div class="col-md-8 ui-front">
                         <select name="typeid" class="form-control">
                            ...
                            <?php foreach($vendor_types->result() as $r) : ?>
            ...
            <div class="form-group">
                ...
                <div class="col-md-8">
                    <input type="text" class="form-control" name="cmpnynme" value="" id="cmpnynme-search">
                </div>
            </div>
            <div class="form-group">
        ...
        <div class="modal-footer">
            ...
            <input type="submit" class="btn btn-primary" value="<?php echo lang("ctn_1554") ?>">
            <?php echo form_close() ?>
        </div>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        "ajax": {
            url : "<?php echo site_url("vendors/vendor_page/" . $page ) ?>",
            type : 'GET',
            data : function ( d ) {
