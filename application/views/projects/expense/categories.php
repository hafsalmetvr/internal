<div class="white-area-content">
    <div class="db-header clearfix">
        ...
        <div class="db-header-extra form-inline"> 
            ...
            <div class="form-group has-feedback no-margin">
             ...
             <button class="btn btn-primary btn-sm" data-toggle="modal" data-target="#addModal"><?php echo lang("ctn_1757") ?></button>
    ...
    <div class="table-responsive">
        <table id="team-table" class="table table-bordered table-striped table-hover">
            <thead>
                <tr class="table-header"><td><?php echo lang("ctn_1758") ?></td><td><?php echo lang("ctn_52") ?></td></tr>
            </thead>
            <tbody>
            </tbody>
        </table>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
        ...
        <div class="modal-body ui-front">
            <?php echo form_open(site_url("projects/add_expense_category"), array("class" => "form-horizontal")) ?>
            <div class="form-group">
                <label for="p-in" class="col-md-4 label-heading"><?php echo lang("ctn_1758") ?></label>
                <div class="col-md-8">
                    <input type="text" class="form-control" name="expense_category" value="">
                </div>
            </div>
        </div>
        ...
        <div class="modal-footer">
            ...
            <input type="submit" class="btn btn-primary" value="<?php echo lang("ctn_1756") ?>">
            <?php echo form_close() ?>
        </div>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        "ajax": {
            url : "<?php echo site_url("projects/expense_category_page/" . $page ) ?>",
            type : 'GET',
            data : function ( d ) {
