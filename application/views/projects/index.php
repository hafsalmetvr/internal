...
<thead>
<tr class="table-header"><td width="50"><?php echo lang("ctn_924") ?></td><td><?php echo lang("ctn_767") ?></td><td><?php echo lang("ctn_775") ?></td><td><?php echo lang("ctn_1550") ?></td><td><?php echo lang("ctn_1698") ?></td><td><?php echo lang("ctn_771") ?></td><td><?php echo lang("ctn_52") ?></td></tr>
</thead>
<tbody>
</tbody>
</table>
      ...
      <div class="modal-body">
         <?php echo form_open_multipart(site_url("projects/add_project"), array("class" => "form-horizontal")) ?>
            ...
            <div class="form-group">
                    ...
                    <div class="col-md-8 ui-front">
                        <input type="text" class="form-control" name="project_at">
                    </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                    ...
                    <div class="col-md-8 ui-front">
                        <input type="text" class="form-control datepicker input-sm" name="start_date">
                    </div>
            </div>
            <div class="form-group">
                    <label for="p-in" class="col-md-4 label-heading"><?php echo lang("ctn_645") ?></label>
                    <div class="col-md-8 ui-front">
                        <input type="text" class="form-control datepicker input-sm" name="end_date">
                    </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
             ...
             <div class="form-group">
                    ...
                    <div class="col-md-8 ui-front">
                        <input type="text" class="form-control datepicker input-sm" name="po_date">
                    </div>
            </div>
            <div class="form-group">
