<div class="white-area-content">
    <div class="db-header clearfix">
        ...
        <div class="db-header-extra form-inline"> 
            ...
            <div class="form-group has-feedback no-margin">
             ...
             <button class="btn btn-primary btn-sm" data-toggle="modal" data-target="#addModal"><?php echo lang("ctn_1617") ?></button>
    ...
    <div class="table-responsive">
        <table id="team-table" class="table table-bordered table-striped table-hover">
            <thead>
                <tr class="table-header"><td><?php echo lang("ctn_1619") ?></td><td><?php echo lang("ctn_1620") ?></td><td><?php echo lang("ctn_52") ?></td></tr>
                <?php foreach($units->result() as $r) : ?>
                <tr><td><?php echo $r->unit_code ?></td><td><?php echo $r->unit_name ?></td><td><a href="<?php echo site_url("product_settings/edit_unit/" . $r->ID) ?>" data-toggle="tooltip" data-placement="bottom" title="<?php echo lang("ctn_55") ?>" class="btn btn-warning btn-xs"><span class="glyphicon glyphicon-cog"></span></a> <a href="<?php echo site_url("product_settings/delete_unit/" . $r->ID . "/" . $this->security->get_csrf_hash()) ?>" class="btn btn-danger btn-xs" onclick="return confirm('<?php echo lang("ctn_317") ?>')" title="<?php echo lang("ctn_57") ?>"  data-toggle="tooltip" data-placement="bottom"><span class="glyphicon glyphicon-trash"></span></a></td></tr>
                <?php endforeach; ?>
            </thead>
            <tbody>
            </tbody>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h4 class="modal-title" id="myModalLabel"><span class="glyphicon glyphicon-folder-open"></span> <?php echo lang("ctn_1618") ?></h4>
        </div>

        <div class="modal-body ui-front">
            <?php echo form_open(site_url("product_settings/add_units"), array("class" => "form-horizontal","id"=>"add_unit")) ?>
        ...
        <div class="modal-footer">
            ...
            <input type="submit" class="btn btn-primary" id="unit_add" value="<?php echo lang("ctn_1618") ?>">
            <?php echo form_close() ?>
        </div>
...
<script type="text/javascript">
    ...
    $('#unit_add').click(function(e)
    {
        ...
        if(Name.length > 0){
            ...
            $.ajax({
                type: 'GET',
                url: base_url+"/product_settings/checkuniquename/"+Name, 
                dataType: 'json',
