<div class="white-area-content">
    <div class="db-header clearfix">
        <div class="page-header-title"> <span class="glyphicon glyphicon-folder-open"></span> <?php echo lang("ctn_1527") ?></div>
    ...
    <div class="table-responsive">
        <table id="team-table" class="table table-bordered table-striped table-hover">
            <thead>
                ...
                <tr><td><?php echo $r->name ?></td><td><a href="<?php echo site_url("suppliers/edit_type/" . $r->ID) ?>" data-toggle="tooltip" data-placement="bottom" title="<?php echo lang("ctn_55") ?>" class="btn btn-warning btn-xs"><span class="glyphicon glyphicon-cog"></span></a> <a href="<?php echo site_url("suppliers/delete_type/" . $r->ID . "/" . $this->security->get_csrf_hash()) ?>" class="btn btn-danger btn-xs" onclick="return confirm('<?php echo lang("ctn_317") ?>')" title="<?php echo lang("ctn_57") ?>"  data-toggle="tooltip" data-placement="bottom"><span class="glyphicon glyphicon-trash"></span></a></td></tr>
                <?php endforeach; ?>
            </thead>
            <tbody>
            </tbody>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h4 class="modal-title" id="myModalLabel"><span class="glyphicon glyphicon-folder-open"></span> <?php echo lang("ctn_1539") ?></h4>
        </div>

        <div class="modal-body ui-front">
            <?php echo form_open(site_url("suppliers/add_supplier_type"), array("class" => "form-horizontal")) ?>
        ...
        <div class="modal-footer">
            ...
            <input type="submit" class="btn btn-primary" value="<?php echo lang("ctn_1539") ?>">
            <?php echo form_close() ?>
        </div>
