...
<div class="db-header db-header-nomargin clearfix">
    <div class="page-header-title"> <span class="glyphicon glyphicon-credit-card"></span> Edit Quotations </div>
...
<?php echo form_open(site_url("quotes/edit/$quotation->id"), array("id" => "order_form")) ?>
    ...
    <div class="tab-content">
        <div role="tabpanel" class="tab-pane active" id="home">
    			...
    			<div class="form-group">
                    ...
                    <?php 
						foreach($clients->result() as $r) { 
							$sel = '';
							if ($quotation->client == $r->ID) {
								$sel = 'selected';
							}
					?>
                        <option <?=$sel;?> value="<?php echo $r->ID ?>"><?php echo $r->username ?></option>
                    <?php } ?>
                    </select>
    				...
    				<div class="col-md-12">
    					<div class="form-group">
    					    <label for="exampleInputEmail1" class="light-label">Date Valid Up-To</label>
    						   <input type="text" value="<?=$quotation->date_upto;?>" name="date_valid" class="form-control datepicker input-sm">
    					</div>
    				</div>
    			</div>
    		...
    		<div class="col-md-3">
    			<div class="form-group">
    			    ...
    			    <input type="text" value="<?=$quotation->attention;?>" name="attention" class="form-control input-sm" >
    			</div>
    			<div class="form-group" >
    			    <label for="exampleInputEmail1" class="light-label"><?php echo lang("ctn_1662") ?></label>
    			    <input type="text" value="<?=$quotation->ref_no;?>" name="refno" class="form-control input-sm" >
    			</div>
    		...
    		<div class="col-md-3">
    			<div class="form-group">
    			    ...
    			    <input type="text" value="<?=$quotation->project;?>" name="project" class="form-control input-sm" id="">
    		                
    			</div>
    			<div class="form-group" id="client-area">
    			    <label for="exampleInputEmail1" class="light-label"><?php echo lang("ctn_1610") ?></label>
    			    <input type="text" value="<?=$quotation->location;?>" name="location" class="form-control input-sm" placeholder="">
    			</div>
    			
    		</div>
    		<div class="col-md-3">
				<label for="exampleInputEmail1" class="light-label">Date</label>
				<input type="text" name="date" value="<?=$quotation->date;?>" class="form-control datepicker input-sm">
			</div>
        </div>
        <div role="tabpanel" class="tab-pane" id="notes">
            ...
            <div class="col-md-6">
                ...
                <textarea name="notes" value="<?=$quotation->notes;?>" class="form-control" placeholder="<?php echo lang("ctn_1439") ?> ..." rows="4"><?=$quotation->notes;?></textarea>
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group">
                    <label for="exampleInputEmail1" class="light-label"><?php echo lang("ctn_1440") ?></label>
                <textarea name="term_notes" value="<?=$quotation->term_notes;?>" class="form-control" placeholder="<?php echo lang("ctn_1441") ?> ..." rows="4"><?=$quotation->term_notes;?></textarea>
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group">
                    <label for="exampleInputEmail1" class="light-label"><?php echo lang("ctn_1442") ?></label>
                <textarea name="hidden_notes" value="<?=$quotation->hidden_notes;?>" class="form-control" placeholder="<?php echo lang("ctn_1443") ?>" rows="4"><?=$quotation->hidden_notes;?></textarea>
                </div>
            </div>
            </div>
...
<div class="white-area-content content-separator clearfix" id="invoice-items-area">
        ...
        <?php $sl = 1;foreach($quotation_items->result() AS $qi) { ?>
        <div <?php if ($sl == $quotation_items->num_rows()) { ?>id="invoice-items"<?php } ?>>
            
            <div class="invoice-item small-text" id="invoice-item-<?=$sl?>">
				
                <div class="row">
                    <div class="col-md-2">
                        <div class="form-group">
                            <label for="exampleInputEmail1" class="light-label"><?php echo lang("ctn_1448") ?></label>
                            <p><input type="text" value="<?=$qi->item_name;?>" name="item_name_<?=$sl?>" id="item_name_<?=$sl?>" class="form-control input-sm" placeholder="<?php echo lang(" ctn_616 ") ?>"></p>
                            <!--<p><input type="text" name="item_desc_1" id="item_desc_1" class="form-control input-sm" placeholder="<?php echo lang(" ctn_1449 ") ?>"></p>-->
                        </div>
                    </div>
					
					<input type="hidden" name="item_id_1" value="<?=$qi->item_id;?>"/>
					
                    <div class="col-md-2">
                        <div class="form-group">
                            <label for="exampleInputEmail1" class="light-label">Description</label>
                            <p><input type="text" value="<?=$qi->description;?>" name="item_description_<?=$sl?>" id="item_description_<?=$sl?>" class="form-control input-sm" placeholder="Enter Description"></p>
                        </div>
                    </div>
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            ...
                            <input type="text" value="<?=$qi->quantity;?>" name="item_quantity_<?=$sl?>" id="item_quantity_<?=$sl?>" class="form-control itemchange input-sm" placeholder="0.00">
                        </div>
                    </div>
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            ...
                            <input type="text" value="<?=$qi->amount;?>" name="item_amount_<?=$sl?>" id="item_amount_<?=$sl?>" class="form-control itemchange input-sm" placeholder="0.00">
                        </div>
                    </div>
                    ...
                    <div class="col-md-1">
                        <div class="form-group">
                            ...
                            <input type="text" readonly name="item_rate_<?=$sl?>" id="item_rate_<?=$sl?>" class="form-control itemchange input-sm" placeholder="0.00">
                        </div>
                    </div>
                    ...
                    <div class="col-md-1">
                        <div class="form-group">
                            ...
                            <input type="text" value="<?=$qi->vat_percentage;?>" name="item_vat_<?=$sl?>" id="item_vat_<?=$sl?>" class="form-control itemchange input-sm" placeholder="5" value="5">
                        </div>
                    </div>
...
<script>
    ...
    function add_item(data = null) {
        ...
        var html = '<div class="invoice-item" id="invoice-item-' + items_count + '">' +
            ...
            '</div>' +
            '</div>';
        $('#invoice-items').last().append(html);
        calculate_total();
    }
