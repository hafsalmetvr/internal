<label for="p-in" class="col-md-4 label-heading"><?php echo lang("ctn_867") ?></label>
                    ...
                    <label for="p-in" class="col-md-4 label-heading"><?php echo lang("ctn_1550") ?></label>
                    <div class="col-md-8 ui-front">
                        <select name="vendors[]" multiple class="form-control chosen-select-no-single" id="ug" data-placeholder="<?php echo lang("ctn_1559") ?>">
                            <?php foreach($vendors->result() as $r) : ?>
                                <option value="<?php echo $r->ID ?>"><?php echo $r->username ?></option>
                            <?php endforeach; ?>
                        </select>
                        <span class="help-block"><?php echo lang("ctn_1560") ?></span>
                    </div>
