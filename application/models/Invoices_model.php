...
class Invoices_Model extends CI_Model 
{
	...
	public function get_item_brands() 
	{
	...
	public function get_item_db($datatable) 
	{
		...
		return $this->db
			->select("invoice_item_db.name, invoice_item_db.ID, invoice_item_db.description,invoice_item_db.category,invoice_item_db.brand,
