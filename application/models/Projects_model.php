...
class Projects_Model extends CI_Model 
{
	...
	public function get_projects($catid, $datatable) 
	{
		...
		return $this->db
			->select("projects.name, projects.ID, projects.description, 
				projects.timestamp, projects.image,projects.project_at,projects.project_value,projects.purchase_order_no,projects.start_date,projects.end_date,projects.project_in_charge,projects.buyer,projects.po_date, projects.userid,projects.vendorid,
				projects.catid, projects.status, projects.complete,
				projects.complete_sync,
				project_categories.name as catname,
				project_categories.color as cat_color,users.username as client_name")
	...
	public function get_projects_user($userid) 
	{
		return $this->db
			->select("projects.name, projects.ID, projects.description, 
				projects.timestamp, projects.image, projects.userid,projects.vendorid,
				projects.catid, projects.status, projects.complete,
				projects.complete_sync,
				project_categories.name as catname,
				project_categories.color as cat_color,users.username as client_name")
	...
	public function get_projects_user_all($catid, $userid, $datatable) 
	{
		...
		return $this->db
			->select("projects.name, projects.ID, projects.description, 
				projects.timestamp, projects.image, projects.userid,projects.vendorid,projects.purchase_order_no,
				projects.catid, projects.status, projects.complete,
				projects.complete_sync,
				project_categories.name as catname,
				project_categories.color as cat_color,users.username as client_name")
	...
	public function get_project($id) 
	{
		return $this->db
			->select("projects.name, projects.ID, projects.description, 
				projects.timestamp, projects.image, projects.userid,projects.vendorid,projects.project_at,projects.project_value,projects.purchase_order_no,projects.start_date,projects.end_date,projects.project_in_charge,projects.buyer,projects.po_date,
				projects.catid, projects.status, projects.complete,
				projects.complete_sync,
