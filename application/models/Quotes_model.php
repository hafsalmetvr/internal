...
class Quotes_Model extends CI_Model 
{
	...
	public function insert_quotations($data)
	{
		$this->db->insert("quotations", $data);
		return $this->db->insert_id();
	}
	
	public function insert_quotation_items($data)
	{
	...
	{
		return $this->db->where("user_role", 11)->get("users");
	}
	...
	public function get_quote($id) {
		return $this->db->where("id", $id)->get("quotations");
	}
	
	public function get_quote_items($id) {
		return $this->db->where("parent_id", $id)->get("quotation_items");
	}
	
	public function delete_quotation_items($id) {
		$this->db->where("parent_id", $id)->delete("quotation_items");
	}
	
	
	public function update_quotations($id, $data)
	{
		$this->db->where("id", $id)->update("quotations", $data);
	}
	
	public function update_quotation_status($id, $data) {
		$this->db->where("id", $id)->update("quotations", $data);
	}
